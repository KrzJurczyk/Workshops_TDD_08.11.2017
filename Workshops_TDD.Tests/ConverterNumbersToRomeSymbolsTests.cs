...
namespace Workshops_TDD.Tests
{
    [TestFixture]
    public class ConverterNumbersToRomeSymbolsTests
    {
        private ConverterNumbersToRomeSymbols _target;

        [SetUp]
        public void Initialize()
        {
            _target = new ConverterNumbersToRomeSymbols();
        }
        [Test, Sequential]
